...
if(!$aiosc_user->can('staff')) $count_query .= " WHERE author_id=$aiosc_user->ID ";
$ticket_count = $wpdb->get_var( $count_query . aiosc_get_query($aiosc_user->can('staff')));
...
$tickets = aiosc_TicketManager::get_tickets($query . aiosc_get_query($aiosc_user->can('staff')) . $ticket_sorting);
