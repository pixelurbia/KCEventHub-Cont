    ...
    <div class="aiosc-form">
        <form method="post" id="aiosc-form" action="<?php echo get_admin_url()?>admin-ajax.php" enctype="multipart/form-data">
            ...
            <div class="aiosc-cholder">
                <label class="hide" for="aiosc-subject"><?php _e('Subject','aiosc')?></label>
                <input type="text" maxlength="255" style="width: 100%" id="aiosc-subject" name="subject" placeholder="subject" />
            </div>
            ...
            <!-- Submit -->
            <div class="aiosc-cholder">
                <input type="submit" class="btn button-primary" id="aiosc-form-submit" value="<?php _e('Submit','aiosc')?>" />
            </div>
        </form>
    </div>
</div>