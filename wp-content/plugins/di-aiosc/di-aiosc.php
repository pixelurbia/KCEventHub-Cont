...
define('AIOSC_UPLOAD_DIR',apply_filters('aiosc_upload_dir',AIOSC_DIR."uploads"));
define('AIOSC_UPLOAD_URL',apply_filters('aiosc_upload_url',AIOSC_URL."uploads"));
...
define('AIOSC_CRON_SK', '19117L9o70u$H7r_0L'); //in case you change this, you will have to change it in your CRON command as well
