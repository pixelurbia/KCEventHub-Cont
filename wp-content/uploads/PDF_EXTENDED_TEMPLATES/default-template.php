...
if ( $form_id == '13' ) {echo 'CERTIFICATION BY APPLICANT: I certify that I have read, have understood and will comply with the requirements of the Application for Traffic Control Permit on this form, and that all information provided in connection with this application is true.';
...
7. I or my designated representative will have a valid Permit on-site during the event and present it upon request to ANY Police Officer prior to, or during the event, as required by Kansas City, Missouri Code of Ordinances.';
...
if ( $form_id == '16' ) {
    echo 'CERTIFICATION BY APPLICANT: I certify that the information submitted in connection with this parade application is true and accurate, to the best of my knowledge. I agree to adhere to the “General Requirements & Conditions” contained herein, and understand that failure to do so will render the parade permit, if issued, void. The City of Kansas City, Missouri shall be held harmless from any liability resulting from the conduct of this event.';
  echo '<br><br>';
    echo '<img class="checkbox" src="'. PDF_PLUGIN_URL .'initialisation/images/check_box.png">';
    echo 'I agree | E-Signature: ';
    echo $form_data['field']['E-Signature'];
