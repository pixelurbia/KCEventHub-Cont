...
// echo $enID;
                        ...
                        echo '<a class="pdfLink" href="/?gf_pdf=1&fid='.$formID.'&lid='.$enID.'&template=default-template.php>Download Full Application PDF &#187;</a>';
                            echo '</div>';
                            echo '</div>';
                        ...
                        // echo '<button class="sticky-list-delete submit">Delete</button> <input type="hidden" name="delete_id" class="sticky-list-delete-id" value="'.$enID.'">';
                        echo '</li>';
                            ...
                            if ( $alch == '2') { 
                                ...
                                echo  '<br>Please advise the company servering the alcohol that they will need to submit the permits to the city and the state.</span>';
                                echo  '<a href="/faqs#what-steps-do-i-need-to-take-to-get-alcohol-permits-for-my-event">Here are the permits and steps to follow.</a></li>';
                            }
                            ...
                            if ( $eventType == '3') { echo '<li class="child '.$eID.'formID25">
                                ...
                                <a href="/block-party/?child=Yes'.$link.'">Fill Out Form</a></li>'; }
                            ...
                            if ( $eventType == '5') { echo '<li class="child '.$eID.'formID29">
                                ...
                                <a href="/festival-permit/?child=Yes'.$link.'">Fill Out Form</a></li>'; }
                            if ( $eventType == '7') { echo '<li class="child '.$eID.'formID16">
                                <span>Parade Permit</span>
                                 <a href="/parade-application/?child=Yes'.$link.'">Fill Out Form</a></li>'; }
